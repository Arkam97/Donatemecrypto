...
import TransactionsExpansions from "views/Userprofile/Components/TransactionsExpansions";
...
class Transactions extends React.Component {
  ...
  componentDidMount() {
    const walletRef = server
      .payments()
      .forAccount(this.props.publicKey)
      .cursor(lastCursor);
    this.setState({
      test: walletRef.stream({
        onmessage: txResponse => {
          ...
          if (
            ...
            txResponse.from == this.props.publicKey &&
            txResponse.asset_type != "native"
          ) {
          ...
          if (
            txResponse.type == "payment" &&
            txResponse.to == this.props.publicKey &&
            txResponse.asset_type != "native"
          ) {
